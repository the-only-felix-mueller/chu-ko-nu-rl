export class Vector {
    constructor(readonly x: number, readonly y: number) {  // TODO 'standardx' claims this constructor is useless.
    }
...
export class BidirectionalVectorMap<T> extends Map<T, Vector> {
    ...
    constructor() {  // TODO 'standardx' claims this constructor is useless.
        super();
    }
